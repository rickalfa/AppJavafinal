 ...
 * @author rb__s
 */
public class ControllerUsuario extends CrudControllerAbs {
    
    private ModelConnbd Conn = new ModelConnbd();
    private ModelUsuario User;
    
    private String tablename;
    private String column_idname = "id_usuario";
    private String[] columns= {"nombre", "email", "phone", "direccion", "password"};
    private String[] columns02= {"id_usuario","nombre", "email", "phone", "direccion", "password"};
    ...
    {
        String query_sql ="select * from usuario where email='"+email+"' and password='"+pass+"' ";
        int result = 0;
        
        try{
            
            result = Conn.ejecutarQuery(query_sql);
    ...
    public String[][] get() {
        ...
        int count_columns = this.columns02.length;
        
        String name = "";
        int count = 0;
        String[][] datesuser = new String[20][7];
              ...
              // datesuser[i][1] =  resulqy.getString("email");
               //datesuser[i][2] =  resulqy.getString("direccion");
                ...
                for(count = 0; count < count_columns; count++){
                     ...
                     datesuser[i][count] =  resulqy.getString(this.columns02[count]);
